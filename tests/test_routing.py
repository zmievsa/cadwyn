...
def test__router_generation__updating_response_model(router: VersionedAPIRouter, reload_autogenerated_modules: None):
...
def test__router_generation__updating_request_models(router: VersionedAPIRouter, reload_autogenerated_modules: None):
    @router.get("/test")
...
def test__router_generation__updating_request_depends(router: VersionedAPIRouter, reload_autogenerated_modules: None):
