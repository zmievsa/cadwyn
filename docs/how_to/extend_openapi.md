...
```python
{! docs_src/how_to/extend_openapi/tutorial001.py hl[1,4,7:9] !}
```
...
```python
{! docs_src/how_to/extend_openapi/tutorial001.py hl[2,15:21] !}
```
...
```python
{! docs_src/how_to/extend_openapi/tutorial001.py hl[22:24] !}
```
...
```python
{! docs_src/how_to/extend_openapi/tutorial001.py hl[13:14,25:26] !}
```
...
```python
{! docs_src/how_to/extend_openapi/tutorial001.py hl[29] !}
```
