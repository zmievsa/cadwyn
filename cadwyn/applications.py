...
from cadwyn.codegen._main import generate_code_for_versioned_packages  # pyright: ignore[reportDeprecated]
    ...
    def __init__(
        ...
        **extra: Any,
        ...
        if self.versions.head_schemas_package is not None:
            generate_code_for_versioned_packages(  # pyright: ignore[reportDeprecated]
